 ...
 */
package org.apache.spark.prompt.flume
...
import org.apache.spark.prompt.StreamingContext
import org.apache.spark.prompt.dstream.ReceiverInputDStream
import org.apache.spark.prompt.flume.sink._
 ...
 * [[org.apache.spark.prompt.flume.sink.SparkSink]]s.
 *
 ...
 */
private[prompt] class FlumePollingInputDStream[T: ClassTag](
...
private[prompt] class FlumePollingReceiver(
