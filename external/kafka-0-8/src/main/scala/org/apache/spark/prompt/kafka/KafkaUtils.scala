...
import org.apache.spark.prompt.api.java._
import org.apache.spark.prompt.dstream.{DStream, InputDStream, ReceiverInputDStream}
...
object KafkaUtils {
   ...
   *    [[org.apache.spark.prompt.kafka.HasOffsetRanges]]).
