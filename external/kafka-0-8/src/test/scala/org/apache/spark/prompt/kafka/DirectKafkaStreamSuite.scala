...
import org.apache.spark.prompt.{Milliseconds, StreamingContext, Time}
import org.apache.spark.prompt.dstream.DStream
import org.apache.spark.prompt.kafka.KafkaCluster.LeaderOffset
import org.apache.spark.prompt.scheduler._
...
class DirectKafkaStreamSuite
  ...
  test("using rate controller") {
    ...
    val kafkaStream = withClue("Error creating direct stream") {
      ...
      new DirectKafkaInputDStream[String, String, StringDecoder, StringDecoder, (String, String)](
        ...
        override protected[prompt] val rateController =
  ...
  private def getDirectKafkaStream(topic: String, mockRateController: Option[RateController]) = {
    ...
    new DirectKafkaInputDStream[String, String, StringDecoder, StringDecoder, (String, String)](
      ...
      override protected[prompt] val rateController = mockRateController
    }
  }
}
...
private[prompt] class ConstantEstimator(@volatile private var rate: Long)
...
private[prompt] class ConstantRateController(id: Int, estimator: RateEstimator, rate: Long)
