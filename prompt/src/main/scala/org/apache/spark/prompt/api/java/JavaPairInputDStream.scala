...
import org.apache.spark.prompt.dstream.InputDStream

/**
 * A Java-friendly interface to [[org.apache.spark.prompt.dstream.InputDStream]] of
 * key-value pairs.
 */
...
object JavaPairInputDStream {
  /**
   * Convert a scala [[org.apache.spark.prompt.dstream.InputDStream]] of pairs to a
   * Java-friendly [[org.apache.spark.prompt.api.java.JavaPairInputDStream]].
   */
