 ...
 *
 * Uses [[org.apache.spark.prompt.util.FileBasedWriteAheadLogWriter]] to write
 * and [[org.apache.spark.prompt.util.FileBasedWriteAheadLogReader]] to read.
 *
 ...
 */
private[prompt] class FileBasedWriteAheadLog(
    conf: SparkConf,
    logDirectory: String,
...
private[prompt] object FileBasedWriteAheadLog {
