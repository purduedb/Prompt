...
package org.apache.spark.prompt.util
...
import org.apache.spark.prompt.util.OpenHashMapBasedStateMap._
import org.apache.spark.util.collection.OpenHashMap

/** Internal interface for defining the map that keeps track of sessions. */
private[prompt] abstract class StateMap[K, S] extends Serializable {
...
private[prompt] object StateMap {
...
private[prompt] class EmptyStateMap[K, S] extends StateMap[K, S] {
...
private[prompt] class OpenHashMapBasedStateMap[K, S](
 ...
 * classes and methods
 */
private[prompt] object OpenHashMapBasedStateMap {
