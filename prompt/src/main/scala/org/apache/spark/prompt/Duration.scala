...
/**
 * Helper object that creates instance of [[org.apache.spark.prompt.Duration]] representing
...
object Durations {
  ...
  /**
   * @return [[org.apache.spark.prompt.Duration]] representing given number of milliseconds.
   */
  def milliseconds(milliseconds: Long): Duration = Milliseconds(milliseconds)

  /**
   * @return [[org.apache.spark.prompt.Duration]] representing given number of seconds.
   */
  def seconds(seconds: Long): Duration = Seconds(seconds)

  /**
   * @return [[org.apache.spark.prompt.Duration]] representing given number of minutes.
   */
