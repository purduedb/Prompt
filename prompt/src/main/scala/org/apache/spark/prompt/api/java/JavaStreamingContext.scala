...
import org.apache.spark.prompt._
import org.apache.spark.prompt.dstream.DStream
import org.apache.spark.prompt.receiver.Receiver
import org.apache.spark.prompt.scheduler.StreamingListener

/**
 * A Java-friendly version of [[org.apache.spark.prompt.StreamingContext]] which is the main
 * entry point for Spark Streaming functionality. It provides methods to create
 * [[org.apache.spark.prompt.api.java.JavaDStream]] and
 * [[org.apache.spark.prompt.api.java.JavaPairDStream.]] from input sources. The internal
...
class JavaStreamingContext(val ssc: StreamingContext) extends Closeable {
   ...
   * [[org.apache.spark.prompt.api.java.JavaPairDStream]].toJavaDStream().
