...
package org.apache.spark.prompt.api.java

import org.apache.spark.prompt.Time

private[prompt] trait PythonStreamingListener{
...
private[prompt] class PythonStreamingListenerWrapper(listener: PythonStreamingListener)
 ...
 */
private[prompt] class JavaStreamingListener {
 ...
 */
private[prompt] sealed trait JavaStreamingListenerEvent

private[prompt] class JavaStreamingListenerBatchSubmitted(val batchInfo: JavaBatchInfo)
  extends JavaStreamingListenerEvent

private[prompt] class JavaStreamingListenerBatchCompleted(val batchInfo: JavaBatchInfo)
  extends JavaStreamingListenerEvent

private[prompt] class JavaStreamingListenerBatchStarted(val batchInfo: JavaBatchInfo)
  extends JavaStreamingListenerEvent

private[prompt] class JavaStreamingListenerOutputOperationStarted(
    val outputOperationInfo: JavaOutputOperationInfo) extends JavaStreamingListenerEvent

private[prompt] class JavaStreamingListenerOutputOperationCompleted(
    val outputOperationInfo: JavaOutputOperationInfo) extends JavaStreamingListenerEvent

private[prompt] class JavaStreamingListenerReceiverStarted(val receiverInfo: JavaReceiverInfo)
  extends JavaStreamingListenerEvent

private[prompt] class JavaStreamingListenerReceiverError(val receiverInfo: JavaReceiverInfo)
  extends JavaStreamingListenerEvent

private[prompt] class JavaStreamingListenerReceiverStopped(val receiverInfo: JavaReceiverInfo)
  extends JavaStreamingListenerEvent
 ...
 */
private[prompt] case class JavaBatchInfo(
    batchTime: Time,
 ...
 */
private[prompt] case class JavaStreamInputInfo(
    inputStreamId: Int,
    numRecords: Long,
 ...
 */
private[prompt] case class JavaReceiverInfo(
    streamId: Int,
    name: String,
    active: Boolean,
    location: String,
 ...
 */
private[prompt] case class JavaOutputOperationInfo(
    batchTime: Time,
    id: Int,
    name: String,
    description: String,
