...
package org.apache.spark.prompt.rdd
...
import org.apache.spark.prompt.{State, StateImpl, Time}
import org.apache.spark.prompt.util.{EmptyStateMap, StateMap}
 ...
 */
private[prompt] case class MapWithStateRDDRecord[K, S, E](
    var stateMap: StateMap[K, S], var mappedData: Seq[E])

private[prompt] object MapWithStateRDDRecord {
 ...
 */
private[prompt] class MapWithStateRDDPartition(
 ...
 */
private[prompt] class MapWithStateRDD[K: ClassTag, V: ClassTag, S: ClassTag, E: ClassTag](
...
private[prompt] object MapWithStateRDD {
