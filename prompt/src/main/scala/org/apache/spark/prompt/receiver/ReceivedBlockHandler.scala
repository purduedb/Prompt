...
package org.apache.spark.prompt.receiver
...
import org.apache.spark.prompt.receiver.WriteAheadLogBasedBlockHandler._
import org.apache.spark.prompt.util.{WriteAheadLogRecordHandle, WriteAheadLogUtils}
import org.apache.spark.util.{Clock, SystemClock, ThreadUtils}
import org.apache.spark.util.io.ChunkedByteBuffer

/** Trait that represents the metadata related to storage of blocks */
private[prompt] trait ReceivedBlockStoreResult {
...
private[prompt] trait ReceivedBlockHandler {
...
/**
 * Implementation of [[org.apache.spark.prompt.receiver.ReceivedBlockStoreResult]]
 * that stores the metadata related to storage of blocks using
 * [[org.apache.spark.prompt.receiver.BlockManagerBasedBlockHandler]]
 */
private[prompt] case class BlockManagerBasedStoreResult(
      blockId: StreamBlockId, numRecords: Option[Long])
  extends ReceivedBlockStoreResult


/**
 * Implementation of a [[org.apache.spark.prompt.receiver.ReceivedBlockHandler]] which
 * stores the received blocks into a block manager with the specified storage level.
 */
private[prompt] class BlockManagerBasedBlockHandler(
 ...
 * Implementation of [[org.apache.spark.prompt.receiver.ReceivedBlockStoreResult]]
 * that stores the metadata related to storage of blocks using
 * [[org.apache.spark.prompt.receiver.WriteAheadLogBasedBlockHandler]]
 */
private[prompt] case class WriteAheadLogBasedStoreResult(
 ...
 */
private[prompt] class WriteAheadLogBasedBlockHandler(
...
private[prompt] object WriteAheadLogBasedBlockHandler {
 ...
 */
private[prompt] class CountingIterator[T](iterator: Iterator[T]) extends Iterator[T] {
