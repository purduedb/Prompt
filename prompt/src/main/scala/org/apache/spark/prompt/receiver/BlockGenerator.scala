...
private[prompt] trait BlockGeneratorListener {
  /**
 ...
 * [[org.apache.spark.prompt.receiver.Receiver]] and puts them into appropriately
 ...
 */
private[prompt] class BlockGenerator(
