 ...
 * operation of a [[org.apache.spark.prompt.dstream.PairDStreamFunctions pair DStream]] (Scala)
 * or a [[org.apache.spark.prompt.api.java.JavaPairDStream JavaPairDStream]] (Java).
 *
...
sealed abstract class State[S] {
   ...
   * [[org.apache.spark.prompt.StateSpec StatSpec]] and the key has not received any new data
...
private[prompt] class StateImpl[S] extends State[S] {
