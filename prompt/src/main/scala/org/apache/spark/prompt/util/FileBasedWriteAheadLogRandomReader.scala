 ...
 * [[org.apache.spark.prompt.util.FileBasedWriteAheadLogWriter]]. Given the file segment info,
 * this reads the record (ByteBuffer) from the log file.
 */
private[prompt] class FileBasedWriteAheadLogRandomReader(path: String, conf: Configuration)
  extends Closeable {
