...
import org.apache.spark.prompt.{Duration, StreamingContext, Time}
import org.apache.spark.prompt.scheduler.RateController
 ...
 * [[org.apache.spark.prompt.dstream.ReceiverInputDStream]] as the parent class.
 *
...
abstract class InputDStream[T: ClassTag](_ssc: StreamingContext)
  ...
  private[prompt] var lastValidTime: Time = null
  ...
  protected[prompt] val rateController: Option[RateController] = None

  /** A human-readable name of this InputDStream */
  private[prompt] def name: String = {
   ...
   */
  protected[prompt] override val baseScope: Option[String] = {
   ...
   * times.
   */
  override private[prompt] def isTimeValid(time: Time): Boolean = {
