...
import org.apache.spark.prompt.scheduler.StreamInputInfo
...
class FileInputDStream[K, V, F <: NewInputFormat[K, V]](
  ...
  protected[prompt] override val checkpointData = new FileInputDStreamCheckpointData
  ...
  @transient private[prompt] var batchTimeToSelectedFiles =
  ...
  protected[prompt] override def clearMetadata(time: Time) {
    batchTimeToSelectedFiles.synchronized {
