...
package org.apache.spark.prompt.scheduler.rate
 ...
 *
 * @see [[org.apache.spark.prompt.scheduler.RateController]]
 */
private[prompt] trait RateEstimator extends Serializable {
