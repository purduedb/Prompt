...
/**
 * A Java-friendly interface to [[org.apache.spark.prompt.dstream.ReceiverInputDStream]], the
...
object JavaPairReceiverInputDStream {
  /**
   * Convert a scala [[org.apache.spark.prompt.dstream.ReceiverInputDStream]] to a Java-friendly
   * [[org.apache.spark.prompt.api.java.JavaReceiverInputDStream]].
   */
