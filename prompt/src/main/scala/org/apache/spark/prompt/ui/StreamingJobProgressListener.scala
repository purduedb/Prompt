...
package org.apache.spark.prompt.ui
...
private[prompt] class StreamingJobProgressListener(ssc: StreamingContext)
...
private[prompt] object StreamingJobProgressListener {
  type SparkJobId = Int
  type OutputOpId = Int
}
