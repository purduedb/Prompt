...
import org.apache.spark.prompt.api.java.{JavaDStreamLike, JavaDStream, JavaStreamingContext}

/** Exposes streaming test functionality in a Java-friendly way. */
trait JavaTestBase extends TestSuiteBase {

  /**
   * Create a [[org.apache.spark.prompt.TestInputStream]] and attach it to the supplied context.
   ...
   * [[org.apache.spark.prompt.TestOutputStream]].
   **/
