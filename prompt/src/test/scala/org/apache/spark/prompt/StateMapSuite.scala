...
import org.apache.spark.prompt.rdd.MapWithStateRDDRecord
import org.apache.spark.prompt.util.{EmptyStateMap, OpenHashMapBasedStateMap, StateMap}
...
private[prompt] final class KryoState(var state: String) extends KryoSerializable {
