...
import org.apache.spark.prompt.dstream.{DStream, ForEachDStream, InputDStream}
 ...
 */
private[prompt] class DummyDStream(ssc: StreamingContext) extends DStream[Int](ssc) {
 ...
 */
private[prompt] class DummyInputDStream(ssc: StreamingContext) extends InputDStream[Int](ssc) {
