...
import org.apache.spark.prompt.dstream.{ConstantInputDStream, ReceiverInputDStream}
...
private[prompt] class RateTestInputDStream(_ssc: StreamingContext)
...
private[prompt] class RateTestReceiver(receiverId: Int, host: Option[String] = None)
 ...
 * instance.
 */
private[prompt] object RateTestReceiver {
